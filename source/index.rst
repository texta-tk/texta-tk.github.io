...
`EN <https://docs.texta.ee/v2/index.html>`_
`ET <https://docs.texta.ee/v2/et/index.html>`_
...
This documentation contains information about installing and running **TEXTA Toolkit 2.10.x**

The source code for Toolkit's Django REST API is available at `git.texta.ee/texta/texta-rest <https://git.texta.ee/texta/texta-rest>`_.
